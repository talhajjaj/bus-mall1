...
//  while(leImgEli===midImgEli||riImgEli===midImgEli|| leImgEli===riImgEli||doublicationImg.includes(leImgEli)|| doublicationImg.includes(midImgEli)|| doublicationImg.includes(riImgEli)) 
//  {
//      leImgEli= generateImage();
//      midImgEli= generateImage();
//      riImgEli=generateImage();
...
//  }
//  doublicationImg=[]
// doublicationImg.push(leImgEli);
// doublicationImg.push(midImgEli);
// doublicationImg.push(riImgEli)
//  //  renderImg();
