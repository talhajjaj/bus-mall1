...
// function displayImg(){
    ...
    // function handleSubmit(event) {
        ...
        // let ulEl=document.getElementById("view result")
        // let liEl;
        // for (let index=0;index<proudectImgs.length; index++)
        // liEl= document.createElement('li')
        // ulEl.appendChild(liEl)
        // liEl.textContent =
        // `${proudects[index].proudectName} ${proudects[index].views}
        // ${proudects[index].clicks}`
        // proudectviews.push(proudectImgs[index].views)
        //   proudectclicks.push(proudectImgs[index].clicks)
